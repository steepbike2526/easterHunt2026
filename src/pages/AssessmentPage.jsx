  ...
  return (
    <TerminalWindow>
      <div className="space-y-4 text-lime-300">
        <p>
          To determine if you are ready to take on this Easter Hunt Challenge, I
          will begin with a brief skills assessment.
        </p>
        <p>
          You will complete three tasks: one language challenge, one math
          challenge, one physical challenge.
        </p>
      ...
      {activeChallenge && (
        <div className="mt-8 space-y-4 rounded border border-lime-400/50 bg-slate-950/60 p-4">
          <p className="whitespace-pre-line text-lime-200">
            {challengeConfig[activeChallenge].intro}
          </p>
          <input
      ...
      {allComplete && (
        <div className="mt-10 space-y-4 rounded border border-lime-300 bg-lime-950/40 p-5 text-lime-200">
          ...
          <p>
            Challenge initiation detected. Elon vs. EasterBot is now in
            progress.
          </p>
